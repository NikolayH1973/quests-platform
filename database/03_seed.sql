...
-- 2) Версия для возраста 7-9 лет
INSERT INTO quest_versions (quest_id, age_group, difficulty, description)
SELECT id, '7-9', 'easy', 'Простые весёлые задания для младших детей'
FROM quests WHERE slug = 'ashdod-yam';

-- 3) Два вопроса к версии 7-9
...
WHERE q.slug = 'ashdod-yam' AND qv.age_group = '7-9';
...
WHERE qu.slug = 'ashdod-yam' AND qv.age_group = '7-9' AND q.question_number = 1;
